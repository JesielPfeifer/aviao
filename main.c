...
//garantindo valor positivo inserido pelo user
    ...
    while(1)
    {
        system("cls");
        mapa();
        printf("O valor base da sua passagem �: %d", vuser);
        printf("\n----------------------------------------------------------------");
        printf("\n1 - LISTA DE VALORES");
        printf("\n2 - RESERVA DE ASSENTO");
        printf("\n3 - LIBERA��O DE ASSENTO");
        printf("\n4 - CONSULTAR SITUA��O DE UM ASSENTO");
        ...
        case 2:
            ...
            //VERIFICA SE O ASSENTO J� ESTA SENDO USADO
            if(m[parseIndex(letra)][parseIndex2(num)]>0)
            {
                system("cls");
                printf("VAGA J� OCUPADA\n");
            ...
            while((confirm!='S') && (confirm!='s') && (confirm!='n') && (confirm!='N')); //VERIFICA SE A OP��O COLOCADA � IGUAL AOS PADROES ACEITOS
