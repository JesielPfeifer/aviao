...
void tabela(float vuser)
{
    ...
    printf("|-------------------|\t |-----------------|\t |----------------|\t |------------------------|\t |---------------------------|\n");
    printf("|----EXECUTIVA------|\t |-----01-A-06-----|\t |-%08.2f - 2.5-|\t |----%08.2f - 20%%off---|\t |-----%08.2f - 10%%off-----|\n",
           v.fat1, v.desc20Ex, v.desc10);
    printf("|----ECONOMICA------|\t |07-A-10 e 14-A-28|\t |-%08.2f - 0.9-|\t |----%08.2f - 50%%off---|\t |-----%08.2f - 30%%off-----|\n",
           v.fat2, v.desc50E, v.desc30E);
    printf("|SAIDA-DE-EMERGENCIA|\t |-----12-A-13-----|\t |-%08.2f - 1.1-|\t |----%08.2f - 30%%off---|\t |-----%08.2f - 20%%off-----|\n",
           v.fat3, v.desc30SE, v.desc20SE);
    printf("|--SEM-RECLINAGEM---|\t |-----11-E-29-----|\t |-%08.2f - 0.8-|\t |----%08.2f - 70%%off---|\t |-----%08.2f - 50%%off-----|\n\n",
...
void subtraiGanhos(int n, float v)
{
    if (n < 6)
    {
        vToTEx -= v;
...
void libera3()
{
    ...
    float val = vPass2(parseIndex(letra), num, vuser, m[parseIndex(letra)][parseIndex2(num)]);
    subtraiGanhos(parseIndex2(num), val);
